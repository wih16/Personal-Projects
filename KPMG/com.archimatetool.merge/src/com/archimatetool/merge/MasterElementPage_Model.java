...
public class MasterElementPage_Model extends WizardPage {
	 ...
	 * Create the wizard.
	 */
	public MasterElementPage_Model(String one, String two) {
		super("wizardPage");
		setTitle("Select Master Model");
		setDescription("The Master Model's elements will maintain their name and description");
		radio_1 = one; 
		radio_2 = two;
		selection = 1;
	}
